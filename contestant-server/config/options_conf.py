...
def args_parser():
    ...
    parser.add_argument("--model_def", type=str,
                        default="config/finals_contest_crane_federal_conf/yolov3_finals_contest_crane_federal_conf.cfg",
    ...
    # other parameters
    parser.add_argument('--dataset', type=str, default='finals_contest_crane_federal', help="name of dataset: D")
    ...
    parser.add_argument('--server_port', type=int, default=5003, help="port of server")
    parser.add_argument('--client_ips', type=str, default="127.0.0.1,127.0.0.1",
                        help="internet protocols of all the clients")
    parser.add_argument('--client_ports', type=str, default="5004,5005", help="ports of all the clients")
